...
const expectedPackageProducerRun = [
  ...
  "if (packs.length !== 1) {",
  "  console.error(`Expected npm pack JSON to describe exactly one package, got ${packs.length}`);",
  "  process.exit(1);",
  "}",
  "const [pack] = packs;",
  ...
  "  process.exit(1);",
  "}",
  "process.stdout.write(path.resolve(process.argv[3], packs[0].filename));",
  "NODE",
  ')"',
  "",
...
const reviewedReleaseJobContracts = new Map([
  ...
  [
    "verify",
    {
      digest: "b53193ab5c87f828820452a3f30d82983a3e4f20f39374c9f97cf3d65896e8cd",
      permissions: { contents: "read" }
    }
  ],
  [
